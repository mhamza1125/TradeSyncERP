    ...
    public function run(): void
    {
        $sections = [
            ...
            [
                ...
                'description'  => 'Track production progress per manufacturing stage. Each stage records Not Started / In Progress / Completed.',
                'section_type' => 'task_list',
                'icon'         => 'feather-activity',
                'sort_order'   => 140,
                'default_data' => [
                    'stages' => [
                        ['key' => 'cutting',             'label' => 'Cutting',             'status' => 'not_started'],
                        ['key' => 'printing',            'label' => 'Printing',            'status' => 'not_started'],
                        ['key' => 'embroidery',          'label' => 'Embroidery',          'status' => 'not_started'],
                        ['key' => 'stitching',           'label' => 'Stitching',           'status' => 'not_started'],
                        ['key' => 'internal_qc',         'label' => 'Internal QC',         'status' => 'not_started'],
                        ['key' => 'packing',             'label' => 'Packing',             'status' => 'not_started'],
                        ['key' => 'finishing',           'label' => 'Finishing',           'status' => 'not_started'],
                        ['key' => 'washing',             'label' => 'Washing',             'status' => 'not_started'],
                        ['key' => 'ironing',             'label' => 'Ironing',             'status' => 'not_started'],
                        ['key' => 'material_evaluation', 'label' => 'Material Evaluation', 'status' => 'not_started'],
                        ['key' => 'buttoning',           'label' => 'Buttoning',           'status' => 'not_started'],
                        ['key' => 'assembly',            'label' => 'Assembly',            'status' => 'not_started'],
                        ['key' => 'collar',              'label' => 'Collar',              'status' => 'not_started'],
                        ['key' => 'press',               'label' => 'Press',               'status' => 'not_started'],
                        ['key' => 'lasting',             'label' => 'Lasting',             'status' => 'not_started'],
                    ],
                    'notes' => '',
                ],
            ],
            ...
            [
                'name'         => 'Number of Cartons Loaded',
                'slug'         => 'number_of_cartons_loaded',
                'description'  => 'Record the total number of cartons loaded into the container against the expected count.',
                'section_type' => 'checklist',
                'icon'         => 'feather-hash',
                'sort_order'   => 154,
                'default_data' => [
            ...
            [
                'name'         => 'Quantity per Carton',
                'slug'         => 'quantity_per_carton',
                'description'  => 'Verify the declared quantity packed per carton against the actual count.',
                'section_type' => 'checklist',
                'icon'         => 'feather-package',
                'sort_order'   => 155,
                'default_data' => [
                    'declared_qty_per_carton' => '',
                    'verified_qty_per_carton' => '',
                    'remarks'                 => '',
                ],
            ],
            [
