...
@section('title', 'Edit Testing Parameter - TradeSyncERP')
        ...
        <div class="main-content d-flex">
            ...
            <div class="content-area" data-scrollbar-target="#psScrollbarInit">
                <div class="content-area-header bg-white sticky-top">
                    <div class="page-header-left d-flex align-items-center">
                        ...
                        <ul class="breadcrumb ms-3 mb-0">
                            ...
                            <li class="breadcrumb-item">Edit: {{ $parameter->parameter_name }}</li>
                        </ul>
                    </div>
                    <div class="page-header-right ms-auto">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <button type="submit" form="parameterForm" class="btn btn-primary">
                                <i class="feather-save me-2"></i><span>Update Parameter</span>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-area-body">
                    ...
                    <form id="parameterForm" action="{{ route('masters.parameters.update', $parameter) }}" method="POST">
                        @csrf @method('PUT')
                        @include('masters.parameters._form')
                    </form>
                </div>
            </div>
        </div>
