...
@section('title', 'Add Testing Parameter - TradeSyncERP')
...
<div class="nxl-content">
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Add Parameter</li>
            </ul>
        </div>
            ...
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <button type="submit" form="parameterForm" class="btn btn-primary">
                        <i class="feather-save me-2"></i><span>Save Parameter</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="main-content">
        ...
        <form id="parameterForm" action="{{ route('masters.parameters.store') }}" method="POST">
            @csrf
