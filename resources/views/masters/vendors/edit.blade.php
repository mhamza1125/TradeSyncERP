...
@section('title', 'Edit Vendor - TradeSyncERP')
...
<div class="nxl-content">
            ...
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <button type="submit" form="vendorForm" class="btn btn-primary">
                        <i class="feather-save me-2"></i><span>Update Vendor</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="main-content">
        ...
        <form id="vendorForm" action="{{ route('masters.vendors.update', $vendor) }}" method="POST">
            @csrf @method('PUT')
            @include('masters.vendors._form')
        </form>
    </div>
</div>
@endsection
