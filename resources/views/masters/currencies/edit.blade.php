...
@section('title', 'Edit Currency - TradeSyncERP')
...
<div class="nxl-content">
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Edit: {{ $currency->currency_name }}</li>
            </ul>
        </div>
            ...
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <button type="submit" form="currencyForm" class="btn btn-primary">
                        <i class="feather-save me-2"></i><span>Update Currency</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="main-content">
        ...
        <form id="currencyForm" action="{{ route('masters.currencies.update', $currency) }}" method="POST">
            @csrf @method('PUT')
