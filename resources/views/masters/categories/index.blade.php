...
@section('title', 'Product Categories - TradeSyncERP')
        ...
        <div class="content-area" data-scrollbar-target="#psScrollbarInit">
            <div class="content-area-header bg-white sticky-top">
                ...
                <div class="page-header-right ms-auto">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('masters.categories.export-pdf', request()->query()) }}" class="btn btn-light-brand" target="_blank">
                            <i class="feather-download me-2"></i><span>Export PDF</span>
                        </a>
                        @endcan
                        @can('categories.create')
                        <a href="{{ route('masters.categories.create') }}" class="btn btn-primary">
                            <i class="feather-plus me-2"></i><span>Add Category</span>
                        </a>
                        @endcan
                    </div>
                </div>
            ...
            <div id="collapseFilters" class="accordion-collapse collapse">
                <div class="accordion-body pb-2 px-3 pt-3 bg-white border-bottom">
                    <form method="GET" action="{{ route('masters.categories.index') }}">
                        <div class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-1">
                                <a href="{{ route('masters.categories.index') }}" class="btn btn-light-brand w-100">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
