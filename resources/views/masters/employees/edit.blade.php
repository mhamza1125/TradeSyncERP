...
<div class="nxl-content">
        ...
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    <a href="{{ route('masters.employees.show', $employee) }}" class="btn btn-light-brand">
                        <i class="feather-arrow-left me-2"></i><span>Back</span>
                    </a>
                    <button type="submit" form="employeeForm" class="btn btn-primary">
                        <i class="feather-save me-2"></i><span>Update Employee</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="main-content">
        ...
        <form id="employeeForm" action="{{ route('masters.employees.update', $employee) }}" method="POST">
            @csrf @method('PUT')
            @include('masters.employees._form')
        </form>
    </div>
</div>
@endsection
