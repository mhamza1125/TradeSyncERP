...
@section('title', 'Add Employee Record - TradeSyncERP')
...
<div class="nxl-content">
            ...
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <button type="submit" form="employeeForm" class="btn btn-primary">
                        <i class="feather-save me-2"></i><span>Save Employee</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="main-content">
        ...
        <form id="employeeForm" action="{{ route('masters.employees.store') }}" method="POST">
            @csrf
