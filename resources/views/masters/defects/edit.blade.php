...
@section('title', 'Edit Defect — TradeSyncERP')

@section('content')
<div class="nxl-content">
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title"><h5 class="m-b-10">Edit Defect</h5></div>
            <ul class="breadcrumb">
    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('masters.defects.update', $defect) }}" method="POST">
                            @csrf @method('PUT')
                            @include('masters.defects._form')
                            <div class="d-flex gap-2 mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="feather-save me-2"></i>Update Defect
                                </button>
