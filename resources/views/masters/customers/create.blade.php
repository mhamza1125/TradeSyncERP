...
@section('title', 'Add Customer - TradeSyncERP')
...
<div class="nxl-content">
            ...
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <button type="submit" form="customerForm" class="btn btn-primary">
                        <i class="feather-save me-2"></i><span>Save Customer</span>
                    </button>
                </div>
            </div>
    ...
    <div class="main-content">
        ...
        <form id="customerForm" action="{{ route('masters.customers.store') }}" method="POST">
            @csrf
