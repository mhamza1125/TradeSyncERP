...
@section('title', 'Edit Customer - TradeSyncERP')
...
<div class="nxl-content">
            ...
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <button type="submit" form="customerForm" class="btn btn-primary">
                        <i class="feather-save me-2"></i><span>Update Customer</span>
                    </button>
                </div>
            </div>
    ...
    <div class="main-content">
        ...
        <form id="customerForm" action="{{ route('masters.customers.update', $customer) }}" method="POST">
            @csrf
            @method('PUT')
            @include('masters.customers._form')
        </form>
    </div>
    <!-- [ Main Content ] end -->
</div>
