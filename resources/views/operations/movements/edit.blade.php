        ...
        <form id="editMovementForm" action="{{ route('movements.update', $movement) }}" method="POST">
            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input type="text" name="order_number"
                                           ...
                                           placeholder="Optional" value="{{ old('order_number', $movement->order_number ?? '') }}">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <select name="inspection_type_id" class="form-select @error('inspection_type_id') is-invalid @enderror">
                                        ...
                                        <option value="{{ $type->id }}" @selected(old('inspection_type_id', $movement->inspection_type_id) == $type->id)>{{ $type->name }}</option>
                                        @endforeach
                                    </select>
                ...
                <div class="col-xl-4">
                    ...
                    {{-- ── Recipient ────────────────────────────────────────────── --}}
                    @php $currentRecipientType = old('recipient_type', $movement->recipient_type ?? 'Employee'); @endphp
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select name="recipient_type" id="recipientType"
                                    ...
                                    <option value="Employee" @selected($currentRecipientType === 'Employee')>Employee</option>
                                    <option value="Supplier" @selected($currentRecipientType === 'Supplier')>Supplier / Factory</option>
                                    <option value="Customer" @selected($currentRecipientType === 'Customer')>Customer</option>
                                </select>
                            ...
                            <div id="recipientSupplierPanel" class="recipient-panel" style="display:none">
                                <select name="recipient_id" id="recipientSupplierSelect"
                                    ...
                                    <option value="{{ $s->id }}" @selected($currentRecipientType === 'Supplier' && old('recipient_id', $movement->recipient_id) == $s->id)>{{ $s->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div id="recipientCustomerPanel" class="recipient-panel" style="display:none">
                                <select name="recipient_id" id="recipientCustomerSelect"
                                    ...
                                    <option value="{{ $c->id }}" @selected($currentRecipientType === 'Customer' && old('recipient_id', $movement->recipient_id) == $c->id)>{{ $c->display_name }}</option>
                                    @endforeach
                                </select>
                            </div>
