        ...
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Run #{{ $run->run_number }}
                    @php $verdictColors = ['Pass' => 'success', 'Fail' => 'danger', 'Conditional' => 'warning', 'Pending' => 'secondary']; @endphp
        ...
        <form id="runForm"
                ...
                <div class="card-header d-flex justify-content-between align-items-start flex-wrap gap-2">
                    <div>
                        ...
                        <div class="fs-12 text-muted">
                            Type:
                            <strong>{{ $inspection->inspectionType?->name ?? '—' }}</strong>
                            &nbsp;|&nbsp;
                            Report:
                            <strong>{{ $inspection->report_number }}</strong>
                        </div>
                    </div>
                    <div style="min-width:160px">
                        <label class="form-label fw-semibold mb-1 fs-12">Overall Verdict</label>
            ...
            <div class="card mb-4">
                <div class="card-body text-center py-5 text-muted">
                    ...
                    <small>
                        Delete this run and recreate it. Sections are auto-applied based on the
                        inspection type and sample category.
                    </small>
                </div>
            </div>
            @else
