...
@section('title', 'Bank Ledger - TradeSyncERP')

@section('content')
<div class="nxl-content">
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title"><h5 class="m-b-10">Bank Ledger</h5></div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item">Reports</li>
                <li class="breadcrumb-item">Bank Ledger</li>
            </ul>
        </div>
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <a href="{{ route('ledger.bank.export-pdf', request()->query()) }}" class="btn btn-light-brand" target="_blank">
        ...
        <div class="accordion-body pb-2">
            <form method="GET" action="{{ route('ledger.bank') }}">
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('ledger.bank') }}" class="btn btn-light-brand w-100">Reset</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="main-content">
        ...
        @if($accounts->isEmpty())
        <div class="alert alert-warning">No bank accounts found. Please create a Bank account in <a href="{{ route('masters.accounts.create') }}">Masters → Accounts</a>.</div>
        @else
                    ...
                    <div class="card-body py-3">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                @if($account->bank)
                                <div class="text-muted small">{{ $account->bank->bank_name }}</div>
                                @endif
                                <div class="text-muted small">
                                    Currency: <span class="fw-semibold text-dark">{{ $account->currency ?? 'PKR' }}</span>
                                    &nbsp;|&nbsp; Opening Balance: <span class="fw-semibold text-dark">{{ number_format($account->opening_balance, 2) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card stretch stretch-full">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0" id="bankLedger">
