...
@include('exports.partials._pdf-company-header', ['reportTitle' => 'Sample Movement', 'reportRef' => 'MVT-'.$movement->id])

@include('exports.partials._pdf-company-footer', ['centerText' => 'Movement #'.$movement->id])
