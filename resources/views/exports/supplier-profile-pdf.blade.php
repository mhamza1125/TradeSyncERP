...
@include('exports.partials._pdf-company-header', ['reportTitle' => 'Supplier Profile', 'reportSubtitle' => $supplier->name])

@include('exports.partials._pdf-company-footer', ['centerText' => $supplier->name])
