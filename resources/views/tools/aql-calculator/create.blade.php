...
@section('title', 'New AQL Calculation - TradeSyncERP')
...
<div class="nxl-content">
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">New Calculation</li>
            </ul>
        </div>
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    <a href="{{ route('tools.aql-calculator.index') }}" class="btn btn-light-brand">
                        <i class="feather-arrow-left me-2"></i><span>Back</span>
                    </a>
    ...
    <div class="main-content">
        ...
        <form id="aqlCalculationForm" action="{{ route('tools.aql-calculator.store') }}" method="POST">
            @csrf
